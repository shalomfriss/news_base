...
void main() {
  ...
  group('PropagandaApiClient', () {
    late http.Client httpClient;
    late PropagandaApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = PropagandaApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => PropagandaApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = PropagandaApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws PropagandaApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<PropagandaApiMalformedResponse>()),
        );
      });

      test(
          'throws PropagandaApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<PropagandaApiRequestFailure>()
