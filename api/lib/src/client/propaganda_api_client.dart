...
import 'package:propaganda_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template propaganda_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class PropagandaApiMalformedResponse implements Exception {
  /// {@macro propaganda_api_malformed_response}
  const PropagandaApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template propaganda_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class PropagandaApiRequestFailure implements Exception {
  /// {@macro propaganda_api_request_failure}
  const PropagandaApiRequestFailure({
...
/// {@template propaganda_api_client}
/// A Dart API client for the Propaganda API.
/// {@endtemplate}
class PropagandaApiClient {
  /// Create an instance of [PropagandaApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro propaganda_api_client}
  PropagandaApiClient({
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw PropagandaApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        PropagandaApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
